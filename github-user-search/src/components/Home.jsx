    ...
    return (
      <div className="p-[1rem]">
        <div className="text-[1.5rem] h-[70vh] place-content-center ">
          ...
          <div className="space-x">
            ...
            <p className="max-w-[600px] m-auto">
              GitHub Profile Searcher – your gateway to discovering users and
              repositories on GitHub with ease and precision. Whether you're
              looking for a quick user lookup or a detailed repository hunt,
          ...
          <div className="row-flex">
            ...
            <div className="search-card">
              ...
              <p className="text-justify py-4 text-lg/7">
                Unlock powerful querying capabilities beyond single users.
                Specify parameters like languages, topics, stars, or keywords to
                generate a curated list of matching repositories from across
                GitHub. Perfect for in-depth research and bulk discoveries.
              </p>
              <Link to="/advanced">
        ...
        <footer className="pt-[2rem]">
          <small>
            &copy;2025 &middot; By <a href="https://x.com/isnuelo">nuelo</a>{" "}
            &middot; Using
            <a href="https://docs.github.com/en/rest?api"> Github Api</a>
          </small>
        </footer>
      </div>
    );
